...
public class TableRequestBuilder {
    ...
    private final String baseJsonSchema = "{\"schema\": {\"name\": \"\", \"num_rows\": 1, \"file_format\": \"sql\", \"line_ending\": \"unix\", \"table_name\": \"MOCK_DATA\", \"include_create_sql\": true, \"array\": true, \"include_nulls\": true, \"delimiter\": \",\", \"quote_char\": \"\\\"\", \"include_header\": true, \"bom\": false, \"xml_root_element\": \"dataset\", \"xml_record_element\": \"record\", \"append_dataset_id\": \"\", \"columns_attributes\": []}}";
    ...
    public TableRequestBuilder(String tableName) {
        ...
        try {
            ...
            ((ObjectNode) this.schema.get("schema")).put("name", tableName);
